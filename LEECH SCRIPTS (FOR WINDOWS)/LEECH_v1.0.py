...
def phone_number(event):
	...
	url_open()
	phone_directory = re.findall("\d{10}", html_decode) 
	output = " "
...
"""
phone_button = Button(top_frame, text="Leech Phone number")
phone_button.bind("<Button-1>", phone_number)
phone_button.grid(row=4, column=2,sticky=W)
BUGGY CODE 
"""
home.mainloop()